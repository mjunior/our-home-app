...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-2xl bg-slate-100 p-1 text-slate-500 dark:bg-slate-800 dark:text-slate-300",
      className,
    )}
    {...props}
  />
