...
- ◆ **v1.8 Reajuste de Conta e Cartao** — Phases 24-26 (in progress 2026-04-15; 1/3 phases complete)
...
- [ ] **Phase 25: Reajuste de Fatura de Cartao** - Permitir que o usuario informe o valor real de uma fatura de cartao e gerar automaticamente uma transacao `REAJUSTE` na fatura correta. (in progress; 2/3 plans complete)
...
| v1.8 Reajuste de Conta e Cartao | 24-26 | 5/9 | In Progress | — |
