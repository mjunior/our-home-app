...
- [ ] **Phase 7: Fluxo Unico de Lancamentos** - Unificar criacao e regras de avulso, recorrencia e parcelamento em um mesmo contrato transacional.
...
|-------|-----------|----------------|--------|-----------|
| 7. Fluxo Unico de Lancamentos | v1.1 | 0/3 | Not started | - |
