...
- [ ] **Phase 24: Reajuste de Saldo em Conta** - Permitir que o usuario informe o saldo real de uma conta e gerar automaticamente um lancamento `REAJUSTE` positivo ou negativo para igualar o app. (in progress; 2/3 plans complete)
...
| v1.8 Reajuste de Conta e Cartao | 24-26 | 2/9 | In Progress | — |
